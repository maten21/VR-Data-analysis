...
for i = 2:1:size(sData.trials.trialTypesMeta,2)
...
rectangle('Position',[lickDistrStim-1, 4.0025, 2, 10],'FaceColor',mymap(stimulusType,:),'EdgeColor','none'); % stim lick distr
...
saveas(gcf,strcat(fullfile(filePath,'optoFigs',[sData.sessionInfo.sessionID '_Quartiles' '-trialType' num2str(stimulusType)]),'.png'));
close(gcf)
