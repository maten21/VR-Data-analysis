function sData = remapRateOpto(sData,sDataDir)
...
figLegend = {'1-Fam.-off','2-New-on','3-New-off','4-New-on','5-Fam.-on'};
%figLegend = {sData.trials.contextsMeta.name};
hold on
for t = 1:2
...
figure('Color','white','Position',[0 0 400 300])
x = categorical({'1-F-off','2-N-on','3-N-off','4-N-on','5-F-on'});
