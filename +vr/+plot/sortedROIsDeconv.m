...
inputData = sData.imdata.avBinnedRois.avBinnedRoisNBCLightOffDeconv;
% Keap the same, usually BCN light off!
dataForSorting = sData.imdata.avBinnedRois.avBinnedRoisBCNLightOffDeconv;

subset1 = vr.sortROIs(dataForSorting,PCsOnlyInCtrl);
...
data1 = inputData(subset1,:);
data2 = inputData(subset2,:);
...
Xax = (-120+binSize):binSize:(binNumber*binSize);
