...
for ind = 1:1:min(numel(frameIndexes),sData.imdata(i).nSamples)
...
sData.imdata(i).binnedRoisDff = fillmissing(binnedRoisDff,'linear',2);
sData.imdata(i).binnedRoisDeconv = fillmissing(binnedRoisDeconv,'constant',0);
if deconvRateDataExist; sData.imdata(i).binnedRoisDeconvRate = fillmissing(binnedRoisDeconvRate,'linear',2); end
...
if deconvRateDataExist; sData.imdata(i).avBinnedRois.avBinnedRoisDeconvRate = avBinnedRoisDeconvRate; end
