...
% strarts with an sData file containing all the imaging signals
%{

vr.sData.AnalyseRawData_V11_Remap 
vr.sData.fillImdata; % Include imaging data to the sData file
